...
def getAsteroidList(request):
    ...
    # On submit the POST method gives us the start_date and the end_date so we can trigger the API Call
    if request.method == 'POST':
        ...
        # Making the request and formatting it to json
        results = requests.get(urlRequest).json()

        # Initilizing the results List of Asteroids
        asteroids = []

        # Data is dictionnary of String<date> : List<AsteroidData>
